...
class Siswa extends CI_Controller {
	...
	function index($offset = 0, $order_column = 'id', $order_type = 'asc')
	{
		...
		foreach ($siswas as $siswa){
			$this->table->add_row(++$i, 
				...
				anchor('siswa/delete/'.$siswa->id,'delete',array('class'=>'delete','onclick'=>"return confirm('Apakah anda yakin ingin menghapus datasiswa?')"))
			);
		}
	...
	function view($id){
		...
		$data['link_back'] = anchor('siswa/index/','Daftar siswa',array('class'=>'back'));
